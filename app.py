...
if handled:
    ...
    mode = st.sidebar.radio("Modus:", ["Reserveren", "Beheer", "Sleutels"])
...
# 8) Beheer
    ...
    if st.button("🔑 Naar sleuteloverzicht"):
        st.rerun()  # Dit wordt straks vervangen als je aparte pagina’s wilt maken
